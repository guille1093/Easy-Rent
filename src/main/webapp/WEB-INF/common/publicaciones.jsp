 ...
 */-->
            <th:block th:fragment="todo">
                <tr>
                    ...
                    <td>
                        <button class="btn btn-danger" hx-confirm="Are you sure?" hx-target="closest tr" hx-swap="outerHTML swap:1s" hx-trigger="click" th:attr="hx-delete=@{/public/todo/delete}">Delete</button>
                    </td>
                </tr>
            </th:block>
            </tbody>
