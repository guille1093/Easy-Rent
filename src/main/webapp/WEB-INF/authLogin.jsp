            ...
            <div class="card">
                <div class="card-body">
                  ...
                  <span class="app-brand-logo demo">
                    ...
                    <!-- /Logo -->
                    <h4 class="mb-2">Bienvenido a Easy Rent</h4>
                    <p class="mb-4">Porfavor inicie sesión</p>

                    <form id="formAuthentication" class="mb-3" action="/panel/panelusr" method="GET">
<%--                        cambiar a post para cuando carge de verdad xd--%>
                        <div class="mb-3">
                            <label for="email" class="form-label">Usuario o E-Mail</label>
                            <input
                                    type="text"
                                    class="form-control"
                                    id="email"
                    ...
                    <p class="text-center">
                        <span>Nuevo en el sitio?</span>
                        <a href="/register/authRegister">
